...
check_redshift_webtoon_title_table = RedshiftSQLOperator(
...
copy_to_redshift = S3ToRedshiftOperator(
        task_id='s3_to_redshift_webtoon_title',
        schema='raw_data',
        table='tb_webtoon_title',
        s3_bucket='de-3-2',
        s3_key="{{ ti.xcom_pull(task_ids='extract_and_load_s3', key='webtoon_title_path') }}",
        copy_options=[
            "CSV IGNOREHEADER 1", 
            "DATEFORMAT AS 'auto'", 
            "TIMEFORMAT AS 'auto'",
...
check_raw_data_schema >> check_redshift_webtoon_title_table
check_raw_data_schema >> check_redshift_webtoon_comment_table

check_redshift_webtoon_title_table >> copy_to_redshift
